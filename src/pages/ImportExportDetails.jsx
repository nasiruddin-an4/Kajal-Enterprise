...
const ImportExportDetails = () => {
  const { id } = useParams();
  const [service, setService] = useState(null);
  const [loading, setLoading] = useState(true);

  useEffect(() => {
    const importService = servicesData.importExportServices.find(
      (s) => s.id === id
    );
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
              <div className="flex items-center gap-4 mb-6">
                <div className="w-16 h-16 bg-gradient-to-br from-brand-green/10 to-brand-blue/10 rounded-2xl flex items-center justify-center">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <p className="text-gray-600 mb-6">
                Interested in our import/export services? Contact us for
